...
def _advection_constant_vector(of_instance, lead_steps=72):
...
def _advection_semi_lagrangian(of_instance, lead_steps=72):
    ...
    for lead_step in range(lead_steps):
        ...
        coord_source = [coord_source_i.ravel(), coord_source_j.ravel()]
