...
def import_knmi_hdf5(filename, **kwargs):
    ...
    accutime    = kwargs.get("accutime", 5.)
    # TO DO: apply accumulations to different accumulation times if needed
    pixelsize   = kwargs.get("pixelsize", 1000.) # 1.0 or 2.4 km datasets are available
    ...
    # R is divided by 100.0, because the data is saved as 1/100 mm (so, as integers)
